...
{
    public class SalesInvoice : NancyModule
    {
        ...
        private string Add(dynamic data)
        {
            ...
            {
                string docNo = data[SalesInvoiceConstants.DocNo];
                ...
                doc.DocNo = docNo;
                doc.DebtorCode = data[SalesInvoiceConstants.DebtorCode];
                doc.DocDate = DateStringToDateTime(data[SalesInvoiceConstants.Date].ToString());
                doc.ShipInfo = data[SalesInvoiceConstants.ShipInfo];

                dynamic detailList = data[SalesInvoiceConstants.DetailList];

                foreach (dynamic detailObject in detailList)
                {
                    AutoCount.Invoicing.Sales.Invoice.InvoiceDetail detail = doc.AddDetail();
                    detail.ItemCode = detailObject[SalesInvoiceConstants.ItemCode].ToString();
                    detail.UOM = detailObject[SalesInvoiceConstants.Uom].ToString();
                    detail.Qty = decimal.Parse(detailObject[SalesInvoiceConstants.Quantity].ToString());
                    detail.UnitPrice = decimal.Parse(detailObject[SalesInvoiceConstants.UnitPrice].ToString());
                    detail.Discount = detailObject[SalesInvoiceConstants.Discount].ToString();
                }
    ...
    internal static class SalesInvoiceConstants
    {
