...
{
    public class StockAdjustment : NancyModule
    {
        const string DoctypeName = "StockAdjustment";
        const string DatabaseTable = "vStockAdjustment";
        const string DetailTable = "vStockAdjustmentDetail";
        ...
        public static void Test()
        {
            ...
            Utils.print(stockAdjustment.GetAll());
        ...
        private void Run()
        {
            ...
            Post($"/{DoctypeName}/add", args =>
            {
                ...
                List<StockAdjustmentDetailObject> detailObjectsList = new List<StockAdjustmentDetailObject>();
        ...
        private string Add(string docNo, string dateString, string description, string refDocNo, List<StockAdjustmentDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                AutoCount.Stock.StockAdjustment.StockAdjustmentCommand cmd =
                    AutoCount.Stock.StockAdjustment.StockAdjustmentCommand.Create(userSession, userSession.DBSetting);
                AutoCount.Stock.StockAdjustment.StockAdjustment doc = cmd.AddNew();
                ...
                foreach (StockAdjustmentDetailObject detailObject in detailObjectsList)
                {
                    AutoCount.Stock.StockAdjustment.StockAdjustmentDetail detail = doc.AddDetail();
        ...
        private string Edit(string docNo, string dateString, string description, string refDocNo, List<StockAdjustmentDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                AutoCount.Stock.StockAdjustment.StockAdjustmentCommand cmd =
                AutoCount.Stock.StockAdjustment.StockAdjustmentCommand.Create(userSession, userSession.DBSetting);
                AutoCount.Stock.StockAdjustment.StockAdjustment doc = cmd.Edit(docNo);
    ...
    internal class StockAdjustmentDetailObject
    {
